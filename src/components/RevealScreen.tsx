...
export default function RevealScreen({ player, secretPlayer, trollEvent, onHide, onReroll }: RevealScreenProps) {
  ...
  if (player.isImposter) {
    return (
      <>
        ...
        <div className="min-h-screen flex flex-col items-center justify-center p-6 animate-fade-in bg-gradient-to-b from-red-950/30 to-transparent">
          <div className="text-center space-y-8 max-w-md">
            {/* Imposter reveal */}
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 animate-fade-in bg-gradient-to-b from-emerald-950/30 to-transparent">
      <div className="text-center space-y-8 max-w-md">
